...
export default class WebCam extends Component {
  ...
  componentDidMount() {
    ...
    axios.get('https://localhost:5000/user/'+this.props.match.params.id)
      .then(response => {
        this.setState({
  ...
  onSubmit(e) {
    ...
    axios.post('https://localhost:5000/user/update/' + this.props.match.params.id, user)
  ...
  render() {
    ...
    <div className="App">
      ...
      <form onSubmit={this.onSubmit}>
        ...
        <div className="form-group">
          <input className="btn navbar-gradient navlink-custom" type="submit" value="Update User" />
        </div>
      </form>
    </div>
    )
